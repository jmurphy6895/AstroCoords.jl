@testset "J2EqOE Conversion" begin
    ...
    expected_J2IOE = [7.1294270251742e+03; 8.9420945754925e-03; -2.8982382142187e-03; 5.3390774990364e-01; -2.6047736914253e-01; 4.8735182761240e+00]

    @test u_J2IOE ≈ expected_J2IOE rtol=1e-13

    @testset "Step 1" begin
        J2IOE = [7.1294270251742e+03, 8.9420945754925e-03, -2.8982382142187e-03, 5.3390774990364e-01, -2.6047736914253e-01, 4.8735182761240e+00]
    ...
    @testset "Step 9" begin
        ...
        I1, I2, I3, I4, I5, I6 = AstroCoords._step9(a, eⱼ₂, δe, e″δL, Lⱼ₂, Iⱼ₂, δI, sin_half_I″_δh, hⱼ₂, Σlgh)
    ...
    expected_u_IOE = [7.1366000000000e+03; 9.1448530009497e-03; -2.5360921889622e-03; 5.3399247411729e-01; -2.6044553167591e-01; 4.8729592715682e+00]
    ...
    expected_u_koe = [7.1366000000000e+03; 9.4900000000000e-03; 1.2723450247039e+00; 2.0245819323134e+00; 1.0070549784028e+00; 1.8413223608519e+00]

    @test u_koe ≈ expected_u_koe rtol=1e-13

    u_IOE = [7.1366000000000e+03; 9.1448530009497e-03; -2.5360921889622e-03; 5.3399247411729e-01; -2.6044553167591e-01; 4.8729592715682e+00]
