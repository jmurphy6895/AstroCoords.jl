...
ModEq(p::P, f::F, g::G, h::H, k::K, L::LT) where{P,F,G,H,K,LT} = USM7{promote_type(P,F,G,H,K,LT)}(p, f, g, h, k, L)
...
function Base.getindex(p::ModEq, i::Int)
    if i == 1 return p.p
    elseif i == 2 return p.f
    elseif i == 3 return p.g
    elseif i == 4 return p.h
    elseif i == 5 return p.k
    elseif i == 6 return p.L
